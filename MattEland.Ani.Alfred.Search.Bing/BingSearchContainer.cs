...
namespace MattEland.Ani.Alfred.Search.Bing
{
    ...
    public class BingSearchContainer : DataServiceContext
    {
        ...
        /// <param name="Options">
        ///     Specifies options for this request for all Sources. Valid values are:
        ///     DisableLocationDetection, EnableHighlighting. Sample Values : EnableHighlighting.
        /// </param>
        /// <param name="WebSearchOptions">
        ///     Specify options for a request to the Web SourceType. Valid values are:
        ///     DisableHostCollapsing, DisableQueryAlterations. Sample Values : DisableQueryAlterations.
        /// </param>
        /// <param name="Market">
        ...
        /// <param name="ImageFilters">
        ///     Array of strings that filter the response the API sends based on size, aspect, color,
        ///     style, face or any combination thereof. Valid values are: Size:Small, Size:Medium,
        ///     Size:Large, Size:Width:[Width], Size:Height:[Height], Aspect:Square, Aspect:Wide,
        ///     Aspect:Tall, Color:Color, Color:Monochrome, Style:Photo, Style:Graphics, Face:Face,
        ///     Face:Portrait, Face:Other. Sample Values : Size:Small+Aspect:Square.
        /// </param>
        /// <param name="VideoFilters">
        ///     Array of strings that filter the response the API sends based on size, aspect, color,
        ///     style, face or any combination thereof. Valid values are: Duration:Short, Duration:Medium,
        ///     Duration:Long, Aspect:Standard, Aspect:Widescreen, Resolution:Low, Resolution:Medium,
        ///     Resolution:High. Sample Values : Duration:Short+Resolution:High.
        /// </param>
        /// <param name="VideoSortBy"> The sort order of results returned Sample Values : Date. </param>
        /// <param name="NewsLocationOverride">
        ///     Overrides Bing location detection. This parameter is only applicable in en-US market.
        ///     Sample Values : US.WA.
        /// </param>
        /// <param name="NewsCategory">
        ///     The category of news for which to provide results Sample Values : rt_Business.
        /// </param>
        /// <param name="NewsSortBy"> The sort order of results returned Sample Values : Date. </param>
        /// <returns>
        ///     A DataServiceQuery&lt;ExpandableSearchResult&gt;
        /// </returns>
