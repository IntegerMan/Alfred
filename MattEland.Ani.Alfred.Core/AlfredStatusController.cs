...
namespace MattEland.Ani.Alfred.Core
{
    ...
    internal sealed class AlfredStatusController : IStatusController
    {
        ...
        public void Initialize()
        {
            ...
            EnsureAlfredOffline(alfred, header);
            ...
            {
                InitializeComponent(item, header);
            }

            // We're done. Let the world know.
            alfred.Status = AlfredStatus.Online;
            "Initialization Completed; notifying modules and subsystems.".Log(header, LogLevel.Verbose, Console);
        ...
        public void Shutdown()
        {
            ...
            EnsureAlfredOnline(alfred, header);
        ...
        /// <summary>
        ///     Ensures that alfred is offline and throws an <see cref="InvalidOperationException"/> if it isn't.
        /// </summary>
        ...
        private void EnsureAlfredOffline([NotNull] IAlfred alfred,
        ...
        /// <param name="header">The header.</param>
        private void InitializeComponent([NotNull] IAlfredComponent item,
                                         [NotNull] string header)
        {
            ...
            var initializedMessage = string.Format(Locale, "{0} is now initialized.", item.NameAndVersion);
        ...
        /// <param name="item">The item.</param>
        /// <param name="header">The header.</param>
        private void ShutdownComponent([NotNull] IAlfredComponent item,
                                              [NotNull] string header)
        {
        ...
        /// <summary>
        ///     Ensures that Alfred is online and throws an <see cref="InvalidOperationException"/> if it isn't.
        /// </summary>
        ...
        private void EnsureAlfredOnline([NotNull] IAlfred alfred,
                                               [NotNull] string header)
        {
            switch (alfred.Status)
            {
                ...
                case AlfredStatus.Terminating:
                    var terminatingMessage = "Instructed to shut down but system is already shutting down";
