...
// Last Modified:   08/18/2015 at 11:29 AM
// 
...
namespace MattEland.Ani.Alfred.Core.Modules.SysMonitor
{
    ...
    public sealed class CounterMetricProvider : MetricProviderBase
    {
        ...
        public CounterMetricProvider(string categoryName, string counterName, string instance = null) : base(instance ?? counterName)
        {
