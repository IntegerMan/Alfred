...
{
    /// <summary>Class MattElandManticoreCodeFixProvider.</summary>
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(MattElandManticoreCodeFixProvider))]
    [Shared]
    public class MattElandManticoreCodeFixProvider : CodeFixProvider
    {
        ...
        public override sealed async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                                    CodeAction.Create(title,
                                                      c =>
                                                      MakeUppercaseAsync(document, declaration, c),
                                                      title),
                                    diagnostic);
        }
